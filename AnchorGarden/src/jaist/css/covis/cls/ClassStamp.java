...
public class ClassStamp extends PPath implements Layoutable, Selectable, Move {
	...
	public ClassStamp(Covis_Type co, CoVisBuffer buf) {
		...
		if(cv_type instanceof Covis_Sub){
			...
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_UnCapsuledAccount) {
			cv_type_dammy = new Covis_UnCapsuledAccount_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_CapsuledAccount) {
			cv_type_dammy = new Covis_CapsuledAccount_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_Dog) {
			cv_type_dammy = new Covis_Dog_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_Cat) {
			cv_type_dammy = new Covis_Cat_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_Animal) {
			cv_type_dammy = new Covis_Animal_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else{
			addChild(cv_type);
		}
