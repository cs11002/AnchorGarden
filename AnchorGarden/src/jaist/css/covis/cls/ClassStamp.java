...
public class ClassStamp extends PPath implements Layoutable, Selectable, Move {
	...
	public ClassStamp(Covis_Type co, CoVisBuffer buf) {
		...
		if(cv_type instanceof Covis_Sub){
			...
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_UnCapAccount) {
			cv_type_dammy = new Covis_UnCapAccount_Dammy(buffer, true);
			addChild(cv_type_dammy);
		}else if (cv_type instanceof Covis_CapAccount) {
			cv_type_dammy = new Covis_CapAccount_Dammy(buffer, true);
			addChild(cv_type_dammy);
