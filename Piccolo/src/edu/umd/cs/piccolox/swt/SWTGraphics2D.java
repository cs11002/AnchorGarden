...
public class SWTGraphics2D extends Graphics2D {
	...
	protected static HashMap<String,org.eclipse.swt.graphics.Font> FONT_CACHE = new HashMap<String,org.eclipse.swt.graphics.Font>();
	protected static HashMap<Color,org.eclipse.swt.graphics.Color> COLOR_CACHE = new HashMap<Color,org.eclipse.swt.graphics.Color>();
	protected static HashMap<Shape,double[]> SHAPE_CACHE = new HashMap<Shape,double[]>();
	...
	public static void decrementGCCount() {
		...
		if (CACHE_COUNT == 0) {
			for(Iterator<org.eclipse.swt.graphics.Font> i=FONT_CACHE.values().iterator(); i.hasNext();) {
				org.eclipse.swt.graphics.Font font = (org.eclipse.swt.graphics.Font)i.next();
				font.dispose();
			}
			for(Iterator<org.eclipse.swt.graphics.Color> i=COLOR_CACHE.values().iterator(); i.hasNext();) {
